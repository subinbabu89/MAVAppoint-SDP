...
<div class="container-fluid">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<form action="advisorbookappointment" method="post"
				name="advisor_form">
				<div class="row">
					<div class="col-md-2">
						<label for="drp_department"><font color="#0" size="4">Department</font></label>

						<br> <select id="drp_department" onchange="submit();"
							name="drp_department"
							class="btn btn-default btn-lg dropdown-toggle">
							<%
								for (int i = 0; i < departments.size(); i++) {
							%>
							<option id="option" value=<%=i%>>
								<%=departments.get(i).getName()%></option>
							<%
								}
							%>
					...
					<div class="col-md-2">
						...
						<label for="drp_degreeType"><font color="#0" size="4">Degree
								Type</font></label> <br> <select id="drp_degreeType" name="drp_degreeType"
							onchange="submit();"
							class="btn btn-default btn-lg dropdown-toggle">
							<%
					...
					<div class="col-md-4">
						...
						<br> <select id="drp_major" name="drp_major"
							onchange="submit();"
							class="btn btn-default btn-lg dropdown-toggle">
							<%
			...
			%>
			<label><font color="#0" size="5"> Log in to see
					Advisor schedules.</font></label>
			<%
				}
			%>
