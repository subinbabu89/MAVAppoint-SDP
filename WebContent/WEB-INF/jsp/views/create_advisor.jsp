...
<div class="panel-body resize-body center-block">
		...
		<!-- style="display:none" -->	<label style="display:none"  for="isLead"><font color="#0">Lead Advisor</font></label><br>
			<select id="isLead" style="display:none" class="btn btn-default btn-lg dropdown-toggle" value="0">
