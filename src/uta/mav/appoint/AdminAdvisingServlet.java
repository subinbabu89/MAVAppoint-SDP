 ...
 */
@WebServlet("/AdminAdvisingServlet")
public class AdminAdvisingServlet extends HttpServlet {
...
//
			...
			advisors = dbm.getAdvisorsOfDepartment(departments.get(1).getName());
			if (advisors.size() != 0) {
		...
		request.getRequestDispatcher("/WEB-INF/jsp/views/adminadvising.jsp").forward(request, response);
	}
