        ...
        protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            if (user == null){
                ...
                try{
                    ...
                    if (!Boolean.valueOf(request.getParameter("flag")))
                    {
                        ...
                        at.setColortype(request.getParameter("acolor"));//Maithili added this
                        //Visitor v = new AddAppointmentTypeVisitor();
                        //user.accept(v,(Object)at);
                        DatabaseManager dbm = new DatabaseManager();
                        String msg = dbm.updatAppointmentType(user,at);
